...
like_comment_helper.insert_comment = async (comment_obj) => {
    ...
    try {
        ...
        return { "status": 0, "message": "Error occured while inserting comment", "error": err };
    }
};
...
like_comment_helper.insert_like = async (like_obj) => {
    ...
    try {
        ...
        return { "status": 0, "message": "Error occured while inserting like", "error": err };
    }
};
...
like_comment_helper.update_comment = async (comment_id, comment_obj) => {
    try {
        let comment_data = await Comments.findOneAndUpdate(comment_id, comment_obj, { new: true });
        if (!comment_data) {
            return { "status": 2, "message": "comment has not updated" };
        } else {
            return { "status": 1, "message": "comment has been updated", "comment": comment_data };
        }
    } catch (err) {
        return { "status": 0, "message": "Error occured while updating comment", "error": err }
    }
};
...
like_comment_helper.delete_like = async (id) => {
    try {
        ...
        return { "status": 0, "message": "Error occured while deleting like", "error": err };
    }
}
