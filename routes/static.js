  ...
  res.json({
    ...
    todayWorkOut: {
      warmUp: [
        {
          name: "Bench Press Up",
          exercise: "25kg for 6 sets of 6 reps",
          img: ""
        },
        {
          name: "Bent Over Row",
          exercise: "10kg for 5 sets of 12 reps",
          img: ""
        },
        {
          name: "Shoulder Press",
    ...
    badges: {
      data: [
        {
          title: "getting heavy",
          desc: "Lift a total of 1000Kg overall.",
          extra: "500/1000Kg",
          status: "Completed",
          badge_date: "June 8, 2017"
        },
        {
          title: "getting heavy 2",
          desc: "Lift a total of 1000Kg overall.",
          extra: "",
          status: "Completed",
          badge_date: "June 8, 2018"
        },
        {
          title: "getting heavy 3",
          desc: "Lift a total of 1000Kg overall.",
          extra: "500/1000Kg",
          status: "Completed",
          badge_date: "June 8, 2019"
        }
      ]
    },
    weeksCalories: "60978"
  ...
  res.json({
    strength: {
      upperBody: [
        {
          title: "Bench Press",
          imageUrl: "/assets/img/exercise/fitness/img-13.jpg"
        },
        {
          title: "Suppoted Row",
          imageUrl: "/assets/img/exercise/fitness/img-13.jpg"
      ...
      var data = userModel.findOne(req.body, function(err, data) {
        if (err) {
          ...
          res
            ...
            .json({ status: 1, user: data, token: token });
        }
      });
      if (data) {
      } else {
        res
          ...
          .json({ status: 0, message: "Invalid Login" });
      }
    } catch (err) {
      res.status(config.BAD_REQUEST).json({ status: 0, error: err });
    }
