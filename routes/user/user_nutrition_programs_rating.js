...
var user_nutrition_programs_rating_helper = require("../../helpers/user_nutrition_programs_rating_helper");

/**
 * @api {post} /user/user_nutrition_programs_rating Save program rating
 * @apiName  Save Nutrition Program Rating
 * @apiGroup  User Nutrition Program Rating
...
router.post("/", async (req, res) => {
  ...
  if (!errors) {
    ...
    let data = await user_nutrition_programs_rating_helper.save_program_rating(
      programs_rating
    );
